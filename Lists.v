...
Theorem bag_theorem : forall (n : nat) (s : bag), 1 + (count n s) = count n (add n s). 
Proof.
  intros n s. destruct n as [|n' Hn].
  -simpl. reflexivity.
  -simpl. replace (n' =? n') with (true).
  --reflexivity.
  --induction n' as [|n''].
  ---reflexivity.
...
Theorem app_nil_r : forall l : natlist,
  l ++ [] = l.
Proof.
  intros l. induction l as [| n t Hl].
  -reflexivity.
...
Proof.
  intros l1 l2. induction l1 as [|n t Hl1].
...
Proof.
  intros l1 l2. induction l1 as [|h t Hl1].
  -simpl. reflexivity.
  -destruct h.
