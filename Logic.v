...
Proof.
  ...
  split.
  -intro H. apply H5. apply H3. apply H.
  -intro H. apply H4. apply H6. apply H.
Qed.
...
Proof.
  intros A B. induction l as [|h t Hl]. 
  -simpl. intros y. split.
  --intros H. destruct H.
  --intros H. destruct H. destruct H as [H1 H2]. destruct H2.
  -simpl. split.
  --intros H. destruct H as [H1 | H2].
  ---exists h. split.
  ----apply H1.
  ----left. reflexivity.
  ---rewrite -> Hl in H2. destruct H2. destruct H as [H3 H4].
  exists x. split.
  ----apply H3.
  ----right. apply H4.
  --intros H. destruct H. destruct H as [H1 [H2 | H3]].
  ---left. rewrite -> H2. apply H1.
  ---right. rewrite -> Hl. exists x. split.
  ----apply H1.
  ----apply H3.
Qed.
...
Proof.
  ...
  ----left. right. apply H3.
  ----right. apply H4.
  --intros H. rewrite -> IH. destruct H as [H1 | H2].
  ---destruct H1.
  ----left. apply H.
  ----right. left. apply H.
